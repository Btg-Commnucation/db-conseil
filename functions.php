...
function pdw_load_stylesheets_and_scripts() {
	...
	wp_enqueue_script('vuerouter', 'https://unpkg.com/vue-router/dist/vue-router.js', array('vuecdn'), 1.0, true);
    wp_enqueue_script( 'vue', get_template_directory_uri() . '/js/vue.js', array('vuecdn'), '1.0', true);
