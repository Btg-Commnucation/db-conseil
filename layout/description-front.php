...
<div v-if="!loading">
        ...
        <div class="gradient">
            <div class="container">
                ...
                <div class="job-container" :class="!startSearching && dimension">
                    <h2><?php the_field('titre_barre_recherche', 'options'); ?></h2>
                    <form v-if="startSearching" v-on:submit.prevent="onSubmit">
                        ...
                        <router-link :to="{ name: 'Resultats', params: { searchCategorie, searchRegion, searchJobType }}" class="rechercher-job" ><?php the_field('texte_bouton_rechercher', 'options'); ?></router-link>
                    </form>
                </div>
    ...
    <article class="job-description" :class="startSearching && 'openSearch'">
        <div class="container">
            <a class="back-offre" href="/db-conseils/nos-offres"><?php the_field('retour_aux_offres', 'options'); ?></a>
            <section class="title">
            ...
            <section class="details">
                <h3><?php the_field('type_doffre', 'options'); ?></h3>
                <ul>
            ...
            <section class="information">
                <div class="part-one">
                    <h3><?php the_field('titre_information_un', 'options'); ?></h3>
